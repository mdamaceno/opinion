 ...
 */
@Entity
@Table(name = "grid_presenter", catalog = "opinion", schema = "")
@XmlRootElement
@NamedQueries({
...
public class GridPresenter implements Serializable {
    ...
    private Integer id;
    @JoinColumn(name = "presenter_id", referencedColumnName = "id", nullable = false)
    @ManyToOne(optional = false)
    private Presenter presenterId;
    ...
    public GridPresenter(Integer id) {
        this.id = id;
    }
    ...
    public Presenter getPresenterId() {
        return presenterId;
    }

    public void setPresenterId(Presenter presenterId) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof GridPresenter)) {
            return false;
        }
        GridPresenter other = (GridPresenter) object;
